...
sleep 2
echo ----------------
echo nslookup 192.168.34.100
echo
nslookup 192.168.34.100
sleep 2
echo ----------------
echo nslookup prdx-kubew12.ziyotek2.local
echo
nslookup prdx-kubew12.ziyotek2.local
sleep 2
echo ----------------
...
getenforce
echo ----------------
echo nslookup client-name nameserver
